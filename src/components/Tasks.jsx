...
import useStyles from '../themes/TasksStyles';
  ...
  return (
    <div className={classes.root}>
      <div>
        ...
        <Typography className={classes.subText}>Lorem ipsum dolor sit amet, consectetur</Typography>
      </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="71.557" height="65" viewBox="0 0 71.557 65">
              <g id="check-box" transform="translate(0 -20.159)">
                <g id="Group_125" data-name="Group 125" transform="translate(0 20.159)">
                  <path
                    className={clsx({ [classes.hover]: hover === 2 })}
                    id="Path_85"
                    data-name="Path 85"
                    d="M53.231,85.763H9.757V42.289H43.688l9.757-9.757H0V95.52H62.988V55.188l-9.757,9.757Z"
                  ...
                  <path
                    ...
                    id="Path_86"
                    data-name="Path 86"
                    d="M90.208,45.042l-6.9,6.9L99.871,68.5l41.446-41.446-6.9-6.9L99.871,54.706Z"
                    transform="translate(-69.76 -20.159)"
                    fill="#c2cbd8"
                  />
                </g>
              </g>
            </svg>
            <Typography className={clsx(classes.txt, { [classes.hover]: hover === 2 })}>
              Lorem ipsum dolor sit amet, consectetur
            </Typography>
          </div>
        </div>
        <div className={classes.svgSection1}>
